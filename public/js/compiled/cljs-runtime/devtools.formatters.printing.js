...
var len__4736__auto___28495 = arguments.length;
var i__4737__auto___28496 = (0);
while(true){
if((i__4737__auto___28496 < len__4736__auto___28495)){
args__4742__auto__.push((arguments[i__4737__auto___28496]));

var G__28497 = (i__4737__auto___28496 + (1));
i__4737__auto___28496 = G__28497;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28420){
var G__28421 = cljs.core.first(seq28420);
var seq28420__$1 = cljs.core.next(seq28420);
var G__28422 = cljs.core.first(seq28420__$1);
var seq28420__$2 = cljs.core.next(seq28420__$1);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28440_SHARP_){
return (!((cljs.core.meta(p1__28440_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28456__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28460){var _e__27890__auto__ = e28460;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28462){var _e__27890__auto__ = e28462;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28472 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28473 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28473);

try{var map__28477 = opts;
var map__28477__$1 = (((((!((map__28477 == null))))?(((((map__28477.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28477.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28477):map__28477);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28477__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28472);
}});
...
var temp__5733__auto___28514 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___28514)){
var managed_print_level_28515 = temp__5733__auto___28514;
var _STAR_print_level_STAR__orig_val__28487_28516 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28488_28517 = managed_print_level_28515;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28488_28517);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28482_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28482_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28487_28516);
}} else {
job_fn();
}
