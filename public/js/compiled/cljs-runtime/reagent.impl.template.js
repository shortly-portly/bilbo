...
var G__27710 = o;
goog.object.set(G__27710,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27728__delegate = function (args){
...
return G__27728__delegate.call(this,args);};
...
return G__27728__delegate(args);
});
...
var G__27711 = o;
goog.object.set(G__27711,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__27736.cljs$lang$applyTo = (function (arglist__27739){
...
var G__27712 = props;
var G__27712__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27712,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27712);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27712__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27713 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27713,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27713;
}
})(),id_class);
...
var G__27714 = (cljs.core.count(argv) - first_child);
switch (G__27714) {
case (0):
...
var vec__27715 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27715,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27715,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27715,(2),null);
...
var temp__5739__auto___27756 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27756 == null)){
} else {
var key_27757 = temp__5739__auto___27756;
(jsprops.key = key_27757);
}
...
var temp__5739__auto___27758 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___27758 == null)){
} else {
var key_27759 = temp__5739__auto___27758;
(jsprops.key = key_27759);
}
...
var temp__5739__auto___27760 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___27760 == null)){
} else {
var key_27761 = temp__5739__auto___27760;
(jsprops.key = key_27761);
}
...
var temp__5739__auto___27764 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27764 == null)){
} else {
var key_27765 = temp__5739__auto___27764;
(jsprops.key = key_27765);
}
...
var temp__5739__auto___27766 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___27766 == null)){
} else {
var key_27768 = temp__5739__auto___27766;
(jsprops.key = key_27768);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27718_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27718_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27719 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27719,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27719,(1),null);
...
break;
default:
var G__27773 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27774 = compiler;
v = G__27773;
compiler = G__27774;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27725 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27725 = (function (opts,id,fn_to_element,meta27726){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27725.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27727,meta27726__$1){
var self__ = this;
var _27727__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27725(self__.opts,self__.id,self__.fn_to_element,meta27726__$1));
}));

(reagent.impl.template.t_reagent$impl$template27725.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27727){
var self__ = this;
var _27727__$1 = this;
return self__.meta27726;
}));

(reagent.impl.template.t_reagent$impl$template27725.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27725.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27725.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27725.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27725.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta27726","meta27726",24599597,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27725.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27725.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27725");

(reagent.impl.template.t_reagent$impl$template27725.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template27725");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27725.
 */
reagent.impl.template.__GT_t_reagent$impl$template27725 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27725(opts__$1,id__$1,fn_to_element__$1,meta27726){
return (new reagent.impl.template.t_reagent$impl$template27725(opts__$1,id__$1,fn_to_element__$1,meta27726));
});

}

return (new reagent.impl.template.t_reagent$impl$template27725(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
