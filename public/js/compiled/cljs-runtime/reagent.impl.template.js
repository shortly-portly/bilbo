...
var G__37236 = o;
(G__37236[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37439__i < G__37439__a.length) {G__37439__a[G__37439__i] = arguments[G__37439__i + 0]; ++G__37439__i;}
  args = new cljs.core.IndexedSeq(G__37439__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37259){
var map__37260 = p__37259;
var map__37260__$1 = (((((!((map__37260 == null))))?(((((map__37260.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37260.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37260):map__37260);
var props = map__37260__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37260__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37276){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37277__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37322){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37323__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37323__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37358 = jsprops;
(G__37358["defaultValue"] = value);

(G__37358["onChange"] = (function (p1__37315_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37315_SHARP_);
}));
...
var vec__37409 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37409,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37409,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37409,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37453 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37453 == null)){
} else {
var key_37454 = temp__5739__auto___37453;
(jsprops["key"] = key_37454);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37418){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37419__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37421 = reagent.impl.template.__GT_NativeWrapper();
(G__37421["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37422 = wrapped;
(G__37422["syntheticInput"] = true);

return G__37422;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37423 = wrapped__$1;
(G__37423["syntheticOnChange"] = on_change);

return G__37423;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37424 = wrapped__$2;
(G__37424["syntheticOnUpdate"] = on_update);
...
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37427) : reagent.impl.template.as_element.call(null,G__37427));
} else {
...
var len__4736__auto___37481 = arguments.length;
var i__4737__auto___37482 = (0);
while(true){
if((i__4737__auto___37482 < len__4736__auto___37481)){
args__4742__auto__.push((arguments[i__4737__auto___37482]));

var G__37484 = (i__4737__auto___37482 + (1));
i__4737__auto___37482 = G__37484;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37430){
var G__37431 = cljs.core.first(seq37430);
var seq37430__$1 = cljs.core.next(seq37430);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37431,seq37430__$1);
}));
...
break;
default:
var G__37490 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__37490;
continue;
...
var n__4613__auto___37494 = a.length;
var i_37495 = (0);
while(true){
if((i_37495 < n__4613__auto___37494)){
(a[i_37495] = reagent.impl.template.as_element((a[i_37495])));

var G__37496 = (i_37495 + (1));
i_37495 = G__37496;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___37498 = a.length;
var i_37499 = (0);
while(true){
if((i_37499 < n__4613__auto___37498)){
var val_37500 = (a[i_37499]);
if(((cljs.core.vector_QMARK_(val_37500)) && ((reagent.impl.template.key_from_vec(val_37500) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37499] = reagent.impl.template.as_element(val_37500));

var G__37503 = (i_37499 + (1));
i_37499 = G__37503;
continue;
} else {
}
...
var ctx = ({});
var vec__37434 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37434,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37434,(1),null);
...
var G__37437 = (cljs.core.count(argv) - first_child);
switch (G__37437) {
case (0):
