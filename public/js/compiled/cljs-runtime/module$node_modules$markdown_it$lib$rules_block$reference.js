...
"undefined"===typeof state.env.references[label]&&(state.env.references[label]={title:start,href:href});state.parentType=_endLine;state.line=startLine+lines+1;return!0}}
