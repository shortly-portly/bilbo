...
var G__28417 = devtools.prefs.pref(v);
v = G__28417;
continue;
} else {
return v;
...
}catch (e28366){var _e__27890__auto__ = e28366;
return false;
}})();
...
}catch (e28374){var _e__27890__auto__ = e28374;
return false;
}})();
...
}catch (e28376){var _e__27890__auto__ = e28376;
return false;
}}
}
});
...
var vec__28400 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28400,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28400,(1),null);
...
return cljs.core.some((function (p1__28407_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28407_SHARP_);
}),template);
});
