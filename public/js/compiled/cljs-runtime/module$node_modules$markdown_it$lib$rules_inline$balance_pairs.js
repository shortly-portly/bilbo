...
state-openerIdx+minOpenerIdx;closer.open=!1;opener.end=state;opener.jump=minOpenerIdx;opener.close=!1;newMinOpenerIdx=-1;break}}}-1!==newMinOpenerIdx&&(openersBottom[closer.marker][(closer.length||0)%3]=newMinOpenerIdx)}}}module.exports=function(state){var curr,tokens_meta=state.tokens_meta,max=state.tokens_meta.length;processDelimiters(state,state.delimiters);for(curr=0;curr<max;curr++)tokens_meta[curr]&&tokens_meta[curr].delimiters&&processDelimiters(state,tokens_meta[curr].delimiters)}}
//# sourceMappingURL=module$node_modules$markdown_it$lib$rules_inline$balance_pairs.js.map
