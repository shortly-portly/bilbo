...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30828 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30828(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30834 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30834(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30844 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30844(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30863 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30863(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30871 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30871(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30880 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30880(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30883 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30883(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30884 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30884(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30885 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30885(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30886 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30886(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30889 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30889(b);
}
});
