...
var _STAR_print_newline_STAR__orig_val__29440_29538 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29441_29539 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29442_29540 = true;
var _STAR_print_fn_STAR__temp_val__29443_29541 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29442_29540);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29443_29541);

try{var _STAR_print_level_STAR__orig_val__29445_29543 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29446_29544 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29446_29544);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29445_29543);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29441_29539);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29440_29538);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29438){
...
var new_formatters = current_formatters.filter((function (p1__29489_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29489_SHARP_)));
}));
...
var G__29497_29569 = f;
var target__27882__auto___29570 = G__29497_29569;
if(cljs.core.truth_(target__27882__auto___29570)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29497_29569)].join(''),"\n","target__27882__auto__"].join('')));
}

(target__27882__auto___29570["toString"] = (function (){
...
var G__29502_29576 = "%c%s";
var G__29503_29577 = "color:transparent";
var G__29504_29578 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29502_29576,G__29503_29577,G__29504_29578) : f.call(null,G__29502_29576,G__29503_29577,G__29504_29578));
...
var G__29583 = (i__4737__auto___29581 + (1));
i__4737__auto___29581 = G__29583;
continue;
} else {
}
break;
...
var vec__29514 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29514,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29514,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29586__delegate = function (add_fmt,add_args){
...
var G__29586 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29587__i = 0, G__29587__a = new Array(arguments.length -  1);
while (G__29587__i < G__29587__a.length) {G__29587__a[G__29587__i] = arguments[G__29587__i + 1]; ++G__29587__i;}
  add_args = new cljs.core.IndexedSeq(G__29587__a,0,null);
} 
return G__29586__delegate.call(this,add_fmt,add_args);};
G__29586.cljs$lang$maxFixedArity = 1;
G__29586.cljs$lang$applyTo = (function (arglist__29588){
var add_fmt = cljs.core.first(arglist__29588);
var add_args = cljs.core.rest(arglist__29588);
return G__29586__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29507){
var G__29508 = cljs.core.first(seq29507);
var seq29507__$1 = cljs.core.next(seq29507);
var G__29509 = cljs.core.first(seq29507__$1);
var seq29507__$2 = cljs.core.next(seq29507__$1);
var G__29510 = cljs.core.first(seq29507__$2);
var seq29507__$3 = cljs.core.next(seq29507__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29508,G__29509,G__29510,seq29507__$3);
}));
...
var seq__29519 = cljs.core.seq(features);
var chunk__29520 = null;
var count__29521 = (0);
var i__29522 = (0);
while(true){
if((i__29522 < count__29521)){
var feature = chunk__29520.cljs$core$IIndexed$_nth$arity$2(null,i__29522);
...
var G__29594 = seq__29519;
var G__29595 = chunk__29520;
var G__29596 = count__29521;
var G__29597 = (i__29522 + (1));
seq__29519 = G__29594;
chunk__29520 = G__29595;
count__29521 = G__29596;
i__29522 = G__29597;
continue;
} else {
...
var G__29602 = cljs.core.chunk_rest(seq__29519__$1);
var G__29603 = c__4556__auto__;
var G__29604 = cljs.core.count(c__4556__auto__);
var G__29605 = (0);
seq__29519 = G__29602;
chunk__29520 = G__29603;
count__29521 = G__29604;
i__29522 = G__29605;
continue;
} else {
var feature = cljs.core.first(seq__29519__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29606 = cljs.core.next(seq__29519__$1);
var G__29607 = null;
var G__29608 = (0);
var G__29609 = (0);
seq__29519 = G__29606;
chunk__29520 = G__29607;
count__29521 = G__29608;
i__29522 = G__29609;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o29530 = temp__5733__auto__;
return (o29530["version"]);
} else {
return null;
}
})() == null);
